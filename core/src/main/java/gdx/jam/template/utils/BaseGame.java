...
public abstract class BaseGame extends Game implements AssetErrorListener {
    ...
    /*private void assetManager() {
        ...
        assetManager.load("images/included/packed/images.atlas", TextureAtlas.class);
        ...
        // sound
        assetManager.load("audio/sound/click.wav", Sound.class);
        ...
        // sound
        clickSound = assetManager.get("audio/sound/click.wav", Sound.class);
        ...
        textureAtlas = assetManager.get("images/included/packed/images.atlas");
